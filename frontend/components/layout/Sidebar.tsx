...
export default function Sidebar() {
  ...
  const { setTransactionSearchQuery } = useAppStore();
      ...
      >
        ...
        <div className="mt-auto border-t border-white/10 p-3">
          <button
            ...
            className="flex w-full items-center justify-center rounded-xl border border-transparent px-3 py-2 text-text-muted transition-colors hover:border-white/12 hover:bg-white/[0.06] hover:text-white cursor-pointer disabled:opacity-60"
          >
            {sidebarCollapsed ? (
              <LogOut size={16} />
            ) : (
